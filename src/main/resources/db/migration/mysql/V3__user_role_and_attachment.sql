...
create index idx_sys_user_tenant on sys_user (tenant_id, status);
...
create index idx_user_role_lookup on user_role_relation (tenant_id, user_id, enabled);
...
create index idx_patch_attachment on patch_attachment (tenant_id, patch_id, stage, created_at);
