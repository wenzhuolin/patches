...
create index idx_mail_server_default on mail_server_config (tenant_id, is_default, enabled);
...
create index idx_mail_template_event on mail_template (tenant_id, event_code, enabled);
...
create index idx_mail_event_policy_enabled on mail_event_policy (tenant_id, enabled, event_code);
...
create index idx_mail_send_log_status on mail_send_log (tenant_id, status, created_at);
create index idx_mail_send_log_retry on mail_send_log (status, next_retry_at);
create index idx_mail_send_log_biz on mail_send_log (tenant_id, biz_type, biz_id);
...
create index idx_mail_send_task_available on mail_send_task (task_status, available_at);
create index idx_mail_send_task_log_id on mail_send_task (log_id);
...
create index idx_delivery_scenario_status on delivery_scenario (tenant_id, status);
...
create index idx_product_status on product (tenant_id, status);
...
create index idx_scenario_product_rel_product on scenario_product_rel (tenant_id, product_id, status);
create index idx_scenario_product_rel_scenario on scenario_product_rel (tenant_id, scenario_id, status);

create index idx_sys_role_level on sys_role (tenant_id, role_level, enabled);
...
create index idx_permission_def_parent on permission_def (tenant_id, parent_id, enabled);
...
create index idx_role_permission_rel_role on role_permission_rel (tenant_id, role_id);
create index idx_role_permission_rel_perm on role_permission_rel (tenant_id, permission_id);
...
create index idx_user_role_scope_rel_user on user_role_scope_rel (tenant_id, user_id, status);
create index idx_user_role_scope_rel_scope on user_role_scope_rel (tenant_id, scope_level, scenario_id, product_id, status);
...
create index idx_data_scope_policy_role on data_scope_policy (tenant_id, role_id, resource_type, enabled);
...
create index idx_config_change_log on config_change_log (tenant_id, config_type, config_id, created_at);
