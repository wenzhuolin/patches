...
create index if not exists idx_patch_list on patch (tenant_id, product_line_id, current_state, updated_at);
...
create index if not exists idx_transition_patch_time on patch_transition_log (patch_id, created_at);
